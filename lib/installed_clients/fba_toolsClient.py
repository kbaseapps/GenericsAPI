...
class fba_tools(object):
    ...
    def characterize_genome_metabolism_using_model(self, params, context=None):
        ...
        :returns: instance of type "CharacterizeGenomeUsingModelResults" ->
           ...
           (The workspace ID for a FBA data object. @id ws KBaseFBA.FBA)
        """
        return self._client.run_job('fba_tools.characterize_genome_metabolism_using_model',
                                    [params], self._service_ver, context)
    ...
    def run_model_characterization(self, params, context=None):
        ...
        :returns: instance of type "RunModelCharacterizationResults" ->
           ...
           (The workspace ID for a FBA data object. @id ws KBaseFBA.FBA)
        """
        return self._client.run_job('fba_tools.run_model_characterization',
                                    [params], self._service_ver, context)
    ...
    def build_plant_metabolic_model(self, params, context=None):
        ...
        :returns: instance of type "BuildPlantMetabolicModelResults" ->
           ...
           KBaseFBA.FBAModel)
        """
        return self._client.run_job('fba_tools.build_plant_metabolic_model',
                                    [params], self._service_ver, context)
    ...
    def lookup_modelseed_ids(self, params, context=None):
        ...
        :returns: instance of type "LookupModelSEEDIDsResults" -> structure:
           ...
           KBaseReport.Report)
        """
        return self._client.run_job('fba_tools.lookup_modelseed_ids',
                                    [params], self._service_ver, context)
    ...
    def predict_metabolite_biosynthesis_pathway(self, params, context=None):
        ...
        :returns: instance of type
           ...
           KBaseReport.Report)
        """
        return self._client.run_job('fba_tools.predict_metabolite_biosynthesis_pathway',
                                    [params], self._service_ver, context)
    ...
    def build_metagenome_metabolic_model(self, params, context=None):
        ...
        :returns: instance of type "BuildMetabolicModelResults" -> structure:
           ...
           "number_removed_biomass_compounds" of Long
        """
        return self._client.run_job('fba_tools.build_metagenome_metabolic_model',
                                    [params], self._service_ver, context)
    ...
    def fit_exometabolite_data(self, params, context=None):
        ...
        """
        return self._client.run_job('fba_tools.fit_exometabolite_data',
                                    [params], self._service_ver, context)
    ...
    def run_fba_tools_tests(self, params, context=None):
        ...
        :returns: instance of type "RunFbaToolsTestsResult" -> structure:
           ...
           KBaseReport.Report), parameter "ref" of String
        """
        return self._client.run_job('fba_tools.run_fba_tools_tests',
                                    [params], self._service_ver, context)
